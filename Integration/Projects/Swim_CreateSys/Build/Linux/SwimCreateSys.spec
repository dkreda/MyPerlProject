...
cp %{SourceDir}/Common/NDU-WHC/DSU_Group-UAF.xml 	%{_sourcedir}%{SwimKits}/CreateSystem/NDU-WHC/DSU_Group-UAF.xml
cp %{SourceDir}/Common/NDU-WHC/OMU_Group-UAF.xml 	%{_sourcedir}%{SwimKits}/CreateSystem/NDU-WHC/OMU_Group-UAF.xml
cp %{SourceDir}/Common/NDU-WHC/SMU_Group-UAF.xml 	%{_sourcedir}%{SwimKits}/CreateSystem/NDU-WHC/SMU_Group-UAF.xml
cp %{SourceDir}/Common/NDU-WHC/VM_ASU_Group-UAF.xml 	%{_sourcedir}%{SwimKits}/CreateSystem/NDU-WHC/VM_ASU_Group-UAF.xml
cp %{SourceDir}/Common/NDU-WHC/LVU_Group-UAF.xml 	%{_sourcedir}%{SwimKits}/CreateSystem/NDU-WHC/LVU_Group-UAF.xml
...
cp %{SourceDir}/Common/MMG/MTS-UAF.xml		%{_sourcedir}%{SwimKits}/CreateSystem/MMG/MTS-UAF.xml
...
%{SwimKits}/CreateSystem/NDU-WHC/DSU_Group-UAF.xml
%{SwimKits}/CreateSystem/NDU-WHC/OMU_Group-UAF.xml
%{SwimKits}/CreateSystem/NDU-WHC/SMU_Group-UAF.xml
%{SwimKits}/CreateSystem/NDU-WHC/VM_ASU_Group-UAF.xml
%{SwimKits}/CreateSystem/NDU-WHC/LVU_Group-UAF.xml
...
%{SwimKits}/CreateSystem/MMG/MTS-UAF.xml
