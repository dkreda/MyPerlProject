...
%description
%{_PrivateTest} Utility that help to create system info for swim installation
...
cp %{SourceDir}/AddService/VI/DSU_Group-UAF.xml %{_sourcedir}%{SwimKits}/AddServiceUtil/VI/DSU_Group-UAF.xml
cp %{SourceDir}/AddService/VI/OMU_Group-UAF.xml %{_sourcedir}%{SwimKits}/AddServiceUtil/VI/OMU_Group-UAF.xml
cp %{SourceDir}/AddService/VI/SMU_Group-UAF.xml %{_sourcedir}%{SwimKits}/AddServiceUtil/VI/SMU_Group-UAF.xml
cp %{SourceDir}/AddService/VI/VM_ASU_Group-UAF.xml %{_sourcedir}%{SwimKits}/AddServiceUtil/VI/VM_ASU_Group-UAF.xml

cp %{SourceDir}/AddService/VI/LVU_Group-UAF.xml %{_sourcedir}%{SwimKits}/AddServiceUtil/VI/LVU_Group-UAF.xml
...
%{SwimKits}/AddServiceUtil/VI/DSU_Group-UAF.xml
%{SwimKits}/AddServiceUtil/VI/OMU_Group-UAF.xml
%{SwimKits}/AddServiceUtil/VI/SMU_Group-UAF.xml
%{SwimKits}/AddServiceUtil/VI/VM_ASU_Group-UAF.xml
%{SwimKits}/AddServiceUtil/VI/LVU_Group-UAF.xml
